...
#include "UEGitHubManagerInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UUEGitHubManagerInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UUEGitHubManagerInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UUEGitHubManagerInteractiveTool* NewTool = NewObject<UUEGitHubManagerInteractiveTool>(SceneState.ToolManager);
...
UUEGitHubManagerInteractiveToolProperties::UUEGitHubManagerInteractiveToolProperties()
{
...
void UUEGitHubManagerInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UUEGitHubManagerInteractiveTool::Setup()
{
	...
	Properties = NewObject<UUEGitHubManagerInteractiveToolProperties>(this, "Measurement");
...
void UUEGitHubManagerInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UUEGitHubManagerInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UUEGitHubManagerInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UUEGitHubManagerInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UUEGitHubManagerInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UUEGitHubManagerInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UUEGitHubManagerInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UUEGitHubManagerInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UUEGitHubManagerInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{

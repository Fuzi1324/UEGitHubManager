...
#include "UEGitHubManagerInteractiveTool.generated.h"


/**
 * Builder for UUEGitHubManagerInteractiveTool
 */
UCLASS()
class UEGITHUBMANAGER_API UUEGitHubManagerInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UUEGitHubManagerInteractiveTool
 */
UCLASS(Transient)
class UEGITHUBMANAGER_API UUEGitHubManagerInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UUEGitHubManagerInteractiveToolProperties();
...
/**
 * UUEGitHubManagerInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class UEGITHUBMANAGER_API UUEGitHubManagerInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UUEGitHubManagerInteractiveToolProperties> Properties;

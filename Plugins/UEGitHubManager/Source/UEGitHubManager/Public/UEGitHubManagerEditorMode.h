...
#include "UEGitHubManagerEditorMode.generated.h"
 ...
 */
UCLASS()
class UUEGitHubManagerEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_UEGitHubManagerEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UUEGitHubManagerEditorMode();
	virtual ~UUEGitHubManagerEditorMode();
